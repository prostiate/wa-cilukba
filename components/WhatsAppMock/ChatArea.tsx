...
const groupMessages: Message[] = [
  { id: '10', text: 'Morning Team! Updates on the launch?', sender: 'them', senderName: 'John Manager', senderColor: 'text-orange-500', time: '09:00 AM' },
  { id: '11', text: 'Backend is ready to deploy.', sender: 'them', senderName: 'Sarah Dev', senderColor: 'text-purple-500', time: '09:15 AM' },
  { id: '12', text: 'Frontend needs a final polish.', sender: 'me', time: '09:20 AM' },
  { id: '13', text: 'I found a bug in the login flow.', sender: 'them', senderName: 'Mike QA', senderColor: 'text-blue-500', time: '09:30 AM' },
  { id: '14', image: 'https://picsum.photos/600/400?random=102', sender: 'them', senderName: 'Mike QA', senderColor: 'text-blue-500', time: '09:31 AM', isMedia: true },
  { id: '15', text: 'On it. Will fix by noon.', sender: 'me', time: '09:35 AM' },
  { id: '16', text: 'Great work everyone.', sender: 'them', senderName: 'John Manager', senderColor: 'text-orange-500', time: '10:30 AM' },
];
    ...
    <div className="flex-1 flex flex-col h-full bg-[#efeae2] relative">
      ...
      <div className="h-16 bg-[#f0f2f5] px-4 py-2 flex justify-between items-center z-10 border-b border-gray-200">
        <div className="flex items-center cursor-pointer">
          <Avatar src={activeContact.avatar} size="md" blurOverride={settings.chatBlurPhoto} />
          <div className="ml-3 flex flex-col">
            <BlurText active={settings.chatBlurName} className="font-medium text-gray-900 leading-tight">
              {activeContact.name}
            </BlurText>
            <span className="text-xs text-gray-500">
                {activeContact.isGroup ? 'John, Sarah, Mike, You' : 'last seen today at 10:45 AM'}
            </span>
          </div>
        </div>
        ...
        {messages.map((msg) => (
          <div key={msg.id} className={`flex ${msg.sender === 'me' ? 'justify-end' : 'justify-start'}`}>
            ...
            >
              ...
              {activeContact.isGroup && msg.sender !== 'me' && msg.senderName && (
                  <div className={`px-2 pt-1 text-xs font-bold ${msg.senderColor || 'text-gray-500'}`}>

...
import { Download, Shield, Eye, Lock, Zap, CheckCircle2, Moon, Sun, Monitor, Menu, X, ArrowDown } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const handleDownload = () => {
    if (confirm("Download WA Cilukba v1.0.0?\n\n1. Unzip the file\n2. Go to chrome://extensions\n3. Enable 'Developer Mode'\n4. Click 'Load Unpacked'")) {
        downloadExtension();
    }
  };
  ...
  return (
    <PrivacyProvider>
      <div className={`min-h-screen font-sans transition-colors duration-300 dark:bg-slate-900 dark:text-white bg-gray-50 text-slate-900`}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-lg tracking-tight">WA Cilukba</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="hidden sm:flex items-center bg-gray-100 dark:bg-slate-800 rounded-lg p-1">
                  <button 
                    ...
                    className={`p-1.5 rounded-md transition-colors ${theme === 'light' ? 'bg-white dark:bg-slate-600 shadow-sm' : 'text-gray-500 hover:text-gray-900 dark:hover:text-white'}`}
                  >
                    <Sun className="w-4 h-4" />
                  </button>
                  <button 
                    onClick={() => setTheme('system')}
                    className={`p-1.5 rounded-md transition-colors ${theme === 'system' ? 'bg-white dark:bg-slate-600 shadow-sm' : 'text-gray-500 hover:text-gray-900 dark:hover:text-white'}`}
                  >
                    <Monitor className="w-4 h-4" />
                  </button>
                  <button 
                    onClick={() => setTheme('dark')}
                    className={`p-1.5 rounded-md transition-colors ${theme === 'dark' ? 'bg-white dark:bg-slate-600 shadow-sm' : 'text-gray-500 hover:text-gray-900 dark:hover:text-white'}`}
                  >
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-teal-600 to-teal-400">Peek-a-boo!</span> (Cilukba)
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed">
              ...
              We hide your chats until you hover over them. Secure your screen in public spaces.
            </p>
        ...
        <section id="demo-section" className="py-12 bg-gray-100 dark:bg-slate-900/50 border-y border-gray-200 dark:border-white/5 relative">
        ...
        <section className="py-24 bg-white dark:bg-slate-900">
            ...
            <div className="text-center mb-16">
                <h2 className="text-3xl font-bold mb-4">Why choose WA Cilukba?</h2>
                <p className="text-gray-500 dark:text-gray-400">Simple, effective privacy for your daily communications.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                    Automatically detects and blurs sensitive content like photos, names, and messages.
                </p>
                </div>
                <div className="p-8 rounded-2xl bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 hover:border-teal-500/30 transition-colors group">
                <div className="w-12 h-12 bg-white dark:bg-slate-800 rounded-xl flex items-center justify-center mb-6 shadow-sm">
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                    Toggle blurring for specific elements. Keep the chat list visible while hiding the active conversation.
                </p>
                </div>
                <div className="p-8 rounded-2xl bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 hover:border-teal-500/30 transition-colors group">
                <div className="w-12 h-12 bg-white dark:bg-slate-800 rounded-xl flex items-center justify-center mb-6 shadow-sm">
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                    Just like "Cilukba" (Peek-a-boo), hover your mouse to temporarily reveal the content.
                </p>
                </div>
            </div>
            </div>
        ...
        <footer className="py-12 border-t border-gray-200 dark:border-white/10 text-center text-gray-500 text-sm bg-gray-50 dark:bg-slate-900">
            <p>&copy; {new Date().getFullYear()} WA Cilukba. Open Source (MIT). Built with ❤️ for privacy.</p>
        </footer>
      </div>
    </PrivacyProvider>
  );
